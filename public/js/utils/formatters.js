export function formatProperCase(str) {
  ...
  const uppercaseWords = ['WIB', 'FTZ', 'PP', 'UU', 'PMK', 'NIK', 'NIB', 'NPWP', 'SIM', 'SBP', 'LP', 'LPP', 'LPF', 'SPLIT', 'LHP', 'BAP', 'BA', 'KPU', 'BC', 'TMP', 'B', 'C', 'DKI', 'NO', 'NO.', 'NOMOR', 'PBI', 'BPOM', 'BKC', 'NPPBKC', 'EA', 'MMEA', 'HT', 'BDN', 'SPSA', 'BAST', 'CN', 'PIBK'];
